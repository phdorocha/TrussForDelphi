...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.ExtCtrls, Data.DB, Vcl.Grids, Vcl.DBGrids, uDM, Data.Win.ADODB, Vcl.DBCtrls,
...
begin
  if not DM.adsClientes.Active then
    DM.adsClientes.Open;
end;
